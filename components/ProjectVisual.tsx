  ...
  return (
    <div className="bg-bg text-fg-secondary absolute inset-0 overflow-hidden p-4 font-mono text-[11px]">
      <div className="border-border text-fg-muted mb-3 flex items-center gap-2 border-b pb-3 text-[10px] uppercase">
        <span className="bg-status-error h-2 w-2 rounded-full" />
      ...
      <div className="grid h-full grid-cols-[0.7fr_1.3fr] gap-3">
        <div className="border-border space-y-3 border-r pr-3">
          {["Command", "Checkpoints", "Blockers", "Proof"].map((item, index) => (
            ...
            >
              <span className={index === 0 ? "text-accent" : "text-fg-muted"}>{item}</span>
            </div>
          ))}
        </div>
        <div className="space-y-3">
          <div className="border-accent/25 bg-accent/10 h-16 rounded border p-3">
            <div className="bg-accent/70 h-2 w-28" />
            <div className="bg-accent/20 mt-3 h-2 w-full" />
          </div>
          <div className="grid grid-cols-2 gap-3">
            <div className="border-border bg-bg-elevated h-20 rounded border p-3">
              <div className="bg-cyan/65 h-2 w-16" />
              <div className="border-cyan/25 mt-3 h-8 border" />
            </div>
            <div className="border-border bg-bg-elevated h-20 rounded border p-3">
              <div className="bg-amber/65 h-2 w-16" />
              <div className="border-amber/25 mt-3 h-8 border" />
            </div>
          </div>
          <div className="border-border bg-bg-elevated h-20 rounded border p-3">
    ...
    <svg viewBox="0 0 640 400" className="bg-bg absolute inset-0 h-full w-full">
      <defs>
        <linearGradient id="shield-line" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0" stopColor="#77f5b1" />
          <stop offset="1" stopColor="#67d8ef" />
        </linearGradient>
      </defs>
      <rect width="640" height="400" fill="#090b0f" />
      ...
      <path
        ...
        strokeWidth="3"
      />
      <path d="M270 206l34 34 76-88" fill="none" stroke="#77f5b1" strokeWidth="14" />
      <circle cx="122" cy="108" r="7" fill="#f3c66d" />
      <circle cx="514" cy="268" r="7" fill="#67d8ef" />
      <circle cx="120" cy="300" r="5" fill="#77f5b1" />
      <line x1="129" y1="108" x2="198" y2="154" stroke="#26303d" strokeWidth="2" />
      <line x1="507" y1="268" x2="436" y2="226" stroke="#26303d" strokeWidth="2" />
    </svg>
  );
}
